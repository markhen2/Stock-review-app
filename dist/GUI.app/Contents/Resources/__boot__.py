...
_recipes_pil_prescript(['DdsImagePlugin', 'TiffImagePlugin', 'Hdf5StubImagePlugin', 'PalmImagePlugin', 'PsdImagePlugin', 'MspImagePlugin', 'Jpeg2KImagePlugin', 'PdfImagePlugin', 'MpoImagePlugin', 'XVThumbImagePlugin', 'FliImagePlugin', 'MicImagePlugin', 'XbmImagePlugin', 'TgaImagePlugin', 'BlpImagePlugin', 'PixarImagePlugin', 'IptcImagePlugin', 'McIdasImagePlugin', 'GifImagePlugin', 'ImImagePlugin', 'FtexImagePlugin', 'PcdImagePlugin', 'FitsImagePlugin', 'MpegImagePlugin', 'GribStubImagePlugin', 'FpxImagePlugin', 'IcoImagePlugin', 'PpmImagePlugin', 'DcxImagePlugin', 'WmfImagePlugin', 'PngImagePlugin', 'SpiderImagePlugin', 'JpegImagePlugin', 'PcxImagePlugin', 'QoiImagePlugin', 'EpsImagePlugin', 'WebPImagePlugin', 'BufrStubImagePlugin', 'XpmImagePlugin', 'BmpImagePlugin', 'GbrImagePlugin', 'SunImagePlugin', 'SgiImagePlugin', 'IcnsImagePlugin', 'CurImagePlugin', 'ImtImagePlugin'])
